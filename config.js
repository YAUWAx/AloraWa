...
module.exports = {
    ...
    MENU_LOGO: process.env.MENU_LOGO === undefined ?'https://i.ibb.co/J2rwPPj/20211107-201343.jpg' : process.env.MENU_LOGO,
    ...
    PANEL_COMMAND: process.env.PANEL_COMMAND === undefined ? 'dug' : process.env.PANEL_COMMAND,
